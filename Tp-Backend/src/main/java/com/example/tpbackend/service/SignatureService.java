...
public class SignatureService {
    ...
    public SignatureDTO createEmployerSignature(SignatureDTO signatureDTO) throws Exception{
        Utilisateur user = checkForUser(signatureDTO.getUserId());
    ...
    public SignatureDTO getEmployerSignature(String userId) throws Exception {
        Utilisateur user = checkForUser(userId);
    ...
    public void deleteEmployerSignature(String userId) throws Exception {
        Utilisateur user = checkForUser(userId);
        Employer employer = getEmployerFromUser(user);
        Signature signature = signatureRepository.findByUserId(user.getId());
    ...
    private Utilisateur checkForUser(String userId) throws Exception{
        Optional<Utilisateur> user = userRepository.findById(Integer.parseInt(userId));
