...
import FetchsUpdateStatus from "../../../GestionnaireHomePage/dashboard/FetchsUpdateStatus";
...
const CardPageContratsS = ({contrats}) => {
    ...
    const handleUpdateStatus = (matricule, status) => {
        ...
        FethsUpdateStatusS.updateStatusContratVuS(token, matricule, status)
        console.log(status)
    ...
    const filteredContratsList = contrats.length !== 0 && contrats.length !== undefined &&
        contrats.filter((contrat) => filterOptionVuPasVu === "all" || contrat.statusVuPasVuS === filterOptionVuPasVu);
                            ...
                            <List style={{padding: "0px", overflow: "auto", maxHeight: "210px"}}>
                                {filteredContratsList.map((contrat, index) => (
                                    <ListItem key={index}
                                        ...
                                        <ListItemText primary={contrat.statusVuPasVuS === "pasVu" ?
